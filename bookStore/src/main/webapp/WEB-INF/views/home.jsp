					...
					<div class="col-lg-4 col-md-6 mb-4">	
						<div class="card h-100">
							<a href="#"><img class="card-img-top"
								src="${images}/${book.imageUrl}" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">${book.title}</a>
								</h4>
								<h5>${book.unitPrice}</h5>
								<p class="card-text">${book.description}</p>
							</div>
							<div class="card-footer">
								<a href="${contextRoot}/book/${book.id}" class="btn btn-primary btn-sm">View Product</a>
								<a href="${contextRoot}/cart/add/${product.id}/product" class="btn btn-success btn-sm">
