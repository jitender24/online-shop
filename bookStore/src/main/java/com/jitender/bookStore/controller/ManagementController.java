...
public class ManagementController {
    ...
    public String handleBookSubmission(@Valid @ModelAttribute("book") Book mBook,BindingResult bindingResult, Model model) {
//    	System.out.println("Single Book record save ");
//    	if(bindingResult.hasErrors()) {
//        	model.addAttribute("title","Manage Book");
//        	model.addAttribute("userClickManageBook", true);
//        	model.addAttribute("message","Validation fail for Book Submission");
//    		return "page";   
//    	}
//    	
...
//    	
    ...
    public String handleBookActivation(@PathVariable int id) {
    	...
    	return (isActive)?
    			"You have successfully deactivated the book with id " + book.getId()
